...
def compose_bubble(data: pd.DataFrame, playoff_drivers: int, wins_column: str) -> pd.DataFrame:
    ...
    standings_data.loc[
        ...
        'point_diff_to_bubble'] = standings_data['season_points'] - \
    ...
    standings_data['point_diff_to_bubble'] = standings_data['point_diff_to_bubble'].astype(int)
    standings_data.loc[
        standings_data['point_diff_to_bubble'] > 0,
        'point_gap_to_bubble'] = '+' + standings_data[standings_data['point_diff_to_bubble'] > 0].astype(str)
